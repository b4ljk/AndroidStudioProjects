...
public class MainActivity extends AppCompatActivity {
    ...
    private final String appid = "38849a3a8871e7010108324296415325";
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, tempUrl, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        Log.d("TsdaAG", response);
                        JSONArray jsonArray = jsonResponse.list.;
                        Log.d("hehe", String.valueOf(jsonArray.getJSONObject(0)));
                        JSONObject jsonObjectWeather = jsonArray.getJSONObject(0);
                        String description = jsonObjectWeather.getString("description");

                        JSONObject jsonObjectMain = jsonObjectWeather.getJSONObject("main");
                        Log.d("tagtag", String.valueOf(jsonObjectMain));
